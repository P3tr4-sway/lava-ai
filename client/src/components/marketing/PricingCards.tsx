...
const PLANS: Plan[] = [
  {
    ...
    period: 'forever',
    features: [
      { text: '3 AI song breakdowns/month', included: true },
      { text: 'Basic practice tracks', included: true },
      { text: 'PDF export', included: true },
      { text: '2 recording tracks', included: true },
      { text: '100MB storage', included: true },
      { text: 'AI practice assistant', included: true },
    ],
    cta: 'Current Plan',
    ctaVariant: 'outline',
    ctaDisabled: true,
  },
  {
    ...
    period: 'per month',
    features: [
      { text: '50 AI song breakdowns/month', included: true },
      { text: 'Full practice track library', included: true },
      { text: 'PDF + MusicXML export', included: true },
      { text: '8 recording tracks', included: true },
      { text: '5GB storage', included: true },
      { text: 'AI practice coach', included: true },
    ],
    cta: 'Upgrade to Pro',
    ctaVariant: 'default',
    highlighted: true,
  ...
  },
  {
    ...
    period: 'per month',
    features: [
      { text: 'Unlimited AI song breakdowns', included: true },
      { text: 'Full + custom practice tracks', included: true },
      { text: 'All export formats', included: true },
      { text: 'Unlimited recording tracks', included: true },
      { text: '50GB storage', included: true },
      { text: 'Priority AI practice coach', included: true },
    ],
